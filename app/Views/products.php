<?= view('templates/header', [
    'title' => 'IT Hardware Products - Mini PC, Thin Client, Firewall, NAS Storage - TronCart',
    'description' => 'High-performance IT hardware solutions: Deck Mini PC, Deck Neo Thin Client, SecureGate Firewall, HyperNAS Storage, PXL Interactive Panels. Enterprise-grade computing devices for modern businesses.'
]) ?>
            ...
            <div class="row g-0">
                ...
                <div class="col-md-7">
                    <div class="card-body p-5">
                        ...
                        <h3 class="card-title">Deck Mini</h3>
                        <p class="text-primary-custom h5 mb-3">Powerful Mini PC</p>
                        <p class="card-text mb-4">Compact and powerful Mini PC offering revolutionary computing performance in a sleek, space-saving design.</p>
                        <div class="row mb-4">
                            <div class="col-sm-6">
                        ...
                        <div class="mb-3">
                            <span class="badge bg-secondary me-2">Business</span>
                            <span class="badge bg-secondary me-2">Development</span>
                            <span class="badge bg-secondary me-2">Home Office</span>
                            <span class="badge bg-secondary">Enterprise</span>
                        </div>
                        <a href="/contact" class="btn btn-primary">Learn More <i class="bi bi-arrow-right ms-1"></i></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-0">
                ...
                <div class="col-md-7">
                    <div class="card-body p-5">
                        ...
                        <h3 class="card-title">Deck Neo</h3>
                        <p class="text-primary-custom h5 mb-3">Thin Client Revolution</p>
                        <p class="card-text mb-4">A compact, cost-effective thin client that delivers superior performance with up to 70% reduction in infrastructure costs.</p>
                        <div class="row mb-4">
                            <div class="col-sm-6">
                                <ul class="list-unstyled">
                        ...
                        <div class="mb-3">
                            ...
                            <span class="badge bg-secondary me-2">Enterprise</span>
                            <span class="badge bg-secondary me-2">Architecture</span>
            ...
            <div class="row g-0">
                ...
                <div class="col-md-7">
                    <div class="card-body p-5">
                        ...
                        <h3 class="card-title">Deck Studio</h3>
                        <p class="text-primary-custom h5 mb-3">All-in-One Excellence</p>
                        <p class="card-text mb-4">Sleek all-in-one PC combining desktop power with ultra-high quality monitor in one unified unit.</p>
                        <div class="row mb-4">
                            <div class="col-sm-6">
                                <ul class="list-unstyled">
                        ...
                        <div class="mb-3">
                            <span class="badge bg-secondary me-2">Creative</span>
                            <span class="badge bg-secondary me-2">Business</span>
                            <span class="badge bg-secondary me-2">Education</span>
            ...
            <div class="row g-0">
                ...
                <div class="col-md-7">
                    <div class="card-body p-5">
                        ...
                        <h3 class="card-title">SecureGate Firewall</h3>
                        <p class="text-primary-custom h5 mb-3">Network Security</p>
                        <p class="card-text mb-4">Robust network security solution available in 4, 6, and 8-port models, powered by OPNsense platform.</p>
                        <div class="row mb-4">
                            <div class="col-sm-6">
                                <ul class="list-unstyled">
                        ...
                        <div class="mb-3">
                            <span class="badge bg-secondary me-2">SMB</span>
                            <span class="badge bg-secondary me-2">Enterprise</span>
                            <span class="badge bg-secondary me-2">Government</span>
            ...
            <div class="row g-0">
                ...
                <div class="col-md-7">
                    <div class="card-body p-5">
                        ...
                        <h3 class="card-title">HyperNAS</h3>
                        <p class="text-primary-custom h5 mb-3">Centralized Storage</p>
                        <p class="card-text mb-4">Streamline data management with centralized file storage, available in 2, 4, 8, and 12-bay configurations.</p>
                        <div class="row mb-4">
                            <div class="col-sm-6">
                                <ul class="list-unstyled">
                        ...
                        <div class="mb-3">
                            <span class="badge bg-secondary me-2">Enterprise</span>
                            <span class="badge bg-secondary me-2">Media</span>
                            <span class="badge bg-secondary me-2">Development</span>
            ...
            <div class="row g-0">
                ...
                <div class="col-md-7">
                    <div class="card-body p-5">
                        ...
                        <h3 class="card-title">PXL Interactive Panel</h3>
                        <p class="text-primary-custom h5 mb-3">Touch Revolution</p>
                        <p class="card-text mb-4">Lifelike display with touch power, combining color accuracy, durability, and multiple size options for classrooms and meeting rooms.</p>
                        <div class="row mb-4">
                            <div class="col-sm-6">
                                <ul class="list-unstyled">
                        ...
                        <div class="mb-3">
                            <span class="badge bg-secondary me-2">Education</span>
                            <span class="badge bg-secondary me-2">Corporate</span>
...
<section class="py-5 bg-light-custom">
    <div class="container text-center">
        ...
        <p class="lead text-muted mb-4">Download our complete product catalogue</p>
        <a href="/Product_Catalogue.pdf" class="btn btn-primary btn-lg" download><i class="bi bi-download me-2"></i>Download Catalogue</a>
    </div>
</section>
